...
const hasChildrenValues = (arr, character) => {
  ...
  const result = arr.find((elem) => {
    if (Object.values(elem)[0].includes(character)) {
      return true;
    }
  });
...
const hasChildrenEntries = (arr, character) => {
  ...
  if (result.children[0]) return true;
  else return false;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach((element) => {
    ...
    sizes.push({ house: element.house, members: members });
  });
  return sizes;
};
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((element) => {
    ...
    survivors.push({ house: element.house, members: members });
  });
  return survivors;
};
